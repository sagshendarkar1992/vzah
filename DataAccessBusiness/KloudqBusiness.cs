...
{
    public class KloudqBusiness
    {
        DataSet ds;

        public DataTable GetKloudqBusinessList(XDocument Xdoc)
        {
        ...
        public DataSet GetKloudqBusinessDS(XDocument Xdoc)
        {
            SqlHelper SqlObj = new SqlHelper();
            ds = SqlObj.GetDataSet(Xdoc);
            return ds;
        ...
        public DataSet GetDataSet(XDocument xdoc)
        {
            SqlHelper SqlObj = new SqlHelper();
            return SqlObj.GetDataSet(xdoc);
        }
