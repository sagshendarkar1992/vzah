    ...
    public class BundleConfig
    {
        public static void RegisterBundles(BundleCollection bundles)
        {
            ...
            bundles.Add(new StyleBundle("~/Content/css").Include(
                      ...
                      "~/Content/animate.css",
                      "~/Content/style.css", "~/Content/PagedList.css"));
            ...
            bundles.Add(new StyleBundle("~/plugins/timeslider").Include(
                  "~/Content/timeslider.css"));

            bundles.Add(new ScriptBundle("~/bundles/timeslider").Include(
                    "~/Scripts/timeslider.js"));
            ...
            //VueJs Scripts
            bundles.Add(new ScriptBundle("~/script/vueJs").Include(
                    "~/Scripts/VueJs/vue.js",
                    "~/Scripts/VueJs/vee-validate.js",
                    "~/Scripts/VueJs/select2vue.js",
                    "~/Scripts/VueJs/vue-swal.min.js",
                    "~/Scripts/VueJs/vuejs-datepicker.min.js",
                     "~/Scripts/VueJs/main.js"
                ));
